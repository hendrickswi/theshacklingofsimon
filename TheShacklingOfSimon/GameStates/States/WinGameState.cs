...
public class WinGameState : IGameState
{
        ...
        Action quitGame)
    {
        ...
        _gameWonSprite = SpriteFactory.Instance.CreateTextSprite("Upheval32", "YOU WIN!")
            .WithFade(0.0f, 0.8f, 0.125f)
            .WithDelay(4.5f);
        _keyboardControlsSprite = SpriteFactory.Instance
            .CreateTextSprite("Upheval16", "Press R to restart, Q to quit.")
            .WithFade(0.0f, 0.8f, 0.125f)
            .WithDelay(6.5f);
        _gamepadControlsSprite = SpriteFactory.Instance
            .CreateTextSprite("Upheval16", "Press A to restart, START to quit.")
            .WithFade(0.0f, 0.8f, 0.125f)
            .WithDelay(6.5f);
    }
